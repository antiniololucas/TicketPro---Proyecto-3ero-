...
namespace GUI
{
    public partial class FormInicio : ServiceForm
    {
        ...
        {
            PanelBtnAdmin.Visible = _sessionManager.HasPermission(1);
            PanelBtnMaestros.Visible = _sessionManager.HasPermission(1);
            PanelSubMenuEntradas.Visible = _sessionManager.HasPermission(2) || _sessionManager.HasPermission(3);
            if(PanelSubMenuEntradas.Visible )
            {
                panelSubMenuVendedor.Visible = _sessionManager.HasPermission(2);
                panelSubMenuCajero.Visible = _sessionManager.HasPermission(3);
            }
        }
